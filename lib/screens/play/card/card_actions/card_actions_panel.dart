...
class CardActionsPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
        ...
        children: [
          CardActionPanel(actions!.asMap().containsKey(0) ? actions[0] : null,
              readOnly: readOnly),
          CardActionPanel(actions.asMap().containsKey(1) ? actions[1] : null,
              readOnly: readOnly),
          CardActionPanel(actions.asMap().containsKey(2) ? actions[2] : null,
              readOnly: readOnly),
        ]);
  }
}
