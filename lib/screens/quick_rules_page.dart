    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child:
              ...
              _plainText("C - Crew - Basic resource, experienced seafarers"),
              _plainText("L - Landlubbers - Basic resource, inexperienced seafarers"),
              _plainText("F - Food - Basic resource, needed to sustain your crew"),
              _plainText("D - Doubloons - Basic resource, the local currency"),
              _plainText("I - Infamy - Special resource tracking unwanted attention"),
              _plainText("\nSymbols"),
