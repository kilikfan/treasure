...
void main() {
  ...
  testWidgets('should display the game over page with correct text if we have a game result',
          (WidgetTester tester) async {
        final state = makeGameState();
        ...
        await tester
            .pumpWidget(createWidgetForTesting(child: PlayPage('Play Page', state)));
        ...
        // TODO - this doesn't work - expect(find.byType(PlayerHand), findsOneWidget);
        ...
        expect(find.byType(PlayerHand), findsNothing);
        // TODO - this doesn't work - expect(find.text('Rules'), findsOneWidget);
      });
